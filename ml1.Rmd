...
validation_nv$price_label_high <- as.factor(ifelse(validation_nv$price_label_high==TRUE,1,0))

prob_values <- predict(mod_best, validation_nv, type='raw')[,2]
preds_validation_nv <- as.factor(ifelse(prob_values > opt_f1_nv$threshold ,1,0))

metrics_function_num(preds_validation_nv, validation_nv, 'price_label_high')
```
