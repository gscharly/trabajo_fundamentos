...
```{r}
mod <- naiveBayes(price_label_high ~ sqrt_distance_std + Regionname + Type + rooms_cat + kmeans_cluster, data=housesTrain)
```
...
mod <- naiveBayes(price_label_high ~ sqrt_distance_std + Regionname + Type + rooms_cat + kmeans_cluster, data=housesVal)

prob_values <- predict(mod, housesVal, type='raw')
roc_dt <- roc(housesVal$price_label_high, prob_values[,2])
ggplotROCCurve(roc_dt)

opt_f1_obj <- opt_f1_function_v2(prob_values, housesVal, 'price_label_high')
...
metrics_rf = opt_f1_function(values_rf, data_rf, 'price_label_high')
p2_rf_test = opt_f1_function(values_rf, data_rf, 'price_label_high')$p2
metrics_rf$f1_opt
