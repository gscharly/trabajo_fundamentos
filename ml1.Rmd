...
# PCA
Se debe aplicar sobre datos numéricos que hayan sido estandarizados antes (deben estar en el mismo rango de valores). Por ello, usamos el train ser antiguo.s
...
```{r}
test <- read.csv('test_set_new_variables.csv')
