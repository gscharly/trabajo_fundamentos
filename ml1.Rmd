...
```
```{r}
class(housesTrain$kmeans_cluster)
```
...
De todas las combinaciones probadas teniendo en cuenta la información del apartado de selección de variables y a la forma de la anterior gráfica, vamos a formar los clusters cutilizando las variables de latitud y tipo.
...
La curva tiene el punto de inflexión en torno a 0.1, por lo que se escoge este valor como epsilon para DBSCAN.
