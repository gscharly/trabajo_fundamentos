...
opt_f1_obj <- opt_f1_function(prob_values, housesVal, 'price_label_high')
#opt_f1_obj$f1_opt
opt_f1_obj$p1
opt_f1_obj$p2
...
values <- predict(model_svm, data_svm, type = "prob")
...
values <- predict(model_nv, data_nv, type='raw')
