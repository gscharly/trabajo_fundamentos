...
f1_lr = round(opt_f1_function_v2(values_lr, data_lr, 'price_label_high')$f1_opt, 3)
var_lr = 'sell_rate_cat - bed_cat - car_cat - kmeans_cluster - may_have_water - lattitude_std'
p2_lr = opt_f1_function_v2(values_lr, data_lr, 'price_label_high')$p2
...
f1_dt = round(opt_f1_function_v2(values_dt, data_dt, 'price_label_high')$f1_opt, 3)
val_dt = 'Longtitude - Rooms - Lattitude - Type'
parameters_dt = 'cp = 0.013981636'
p2_dt = opt_f1_function_v2(values_dt, data_dt, 'price_label_high')$p2
...
f1_rf = round(opt_f1_function_v2(values_rf[,2], data_rf, 'price_label_high')$f1_opt, 3)
val_rf = 'Rooms - Distance - LandsizeImp - Lattitude - Longtitude - Type'
parameters_rf = 'ntree = 50 / mtry = 3 / nodesize = 11'
p2_rf = opt_f1_function_v2(values_rf[,2], data_rf, 'price_label_high')$p2
...
f1_svm = round(opt_f1_function_v2(values_svm, data_svm, "price_label_high")$f1_opt, 3)
...
p2_svm = opt_f1_function_v2(values_svm, data_svm, 'price_label_high')$p2
...
f1_nv = round(opt_f1_function_v2(values_nv, data_nv, 'price_label_high')$f1_opt, 3)
val_nv = 'sqrt_distance_std + Regionname + Type + rooms_cat + kmeans_cluster'
p2_nv = opt_f1_function_v2(values_nv, data_nv, 'price_label_high')$p2
