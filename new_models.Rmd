...
Se realizan distintas pruebas con interacciones entre las diferentes variables cuantitativas, tomando como base las del mejor modelo obtenido hasta ahora (R2=0.6948)
```{r}
summary(lm(log_price~sqrt_distance:log_landsize + Lattitude + Longtitude + Type + rooms_cat + Regionname + bath_cat + year_built_cat + sell_rate_cat + Method + car_cat, data = train))
```
